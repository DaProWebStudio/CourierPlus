!function(l, n) {
    if ("object" == typeof exports && "object" == typeof module)
        ...
        var u = n();
        for (var t in u)
            ("object" == typeof exports ? exports : l)[t] = u[t]
    }
}(self, (function() {
    return function() {
        var l = {
                ...
                (function() {
                    function l(l, n) {
                        ...
                        for (; t.length && (u = t.shift()); )
                            t.length || void 0 === n ? e = e[u] ? e[u] : e[u] = {} : e[u] = n
                    }
                    function n(l, n) {
                        function u() {}
                        ...
                        for (var u = i(l.j()), t = 0; t < u.length; t++) {
                            ...
                            if (null != n.a[e]) {
                                ...
                                if (d.g)
                                    ...
                                    d = f(n, e),
                                    r ? (r = f(l, e)) ? o(r, d) : h(l, e, d.clone()) : h(l, e, d)
                            }
                        }
                    }
                    function f(l, n) {
                    ...
                    function C(l) {
                        for (var n = l.f.length, u = 0; u < n; ++u) {
                            ...
                            if (-1 != d.indexOf("|"))
                                ...
                                var a;
                                d = (d = d.replace(el, "\\d")).replace(rl, "\\d"),
                                t(e.m),
                                a = e;
                                var o = c(o, 2)
                                  , f = "999999999999999".match(d)[0];
                                0 < (a = f.length < a.a.b.length ? "" : (a = f.replace(new RegExp(d,"g"), o)).replace(RegExp("9", "g"), " ")).length ? (e.m.a(a),
                                e = !0) : e = !1
                            }
                            if (e)
                                return l.w = i,
                    ...
                    function N(l, n) {
                        for (var u = [], t = n.length - 3, e = l.f.length, r = 0; r < e; ++r) {
                            var i = l.f[r];
                            0 == p(i, 3) ? u.push(l.f[r]) : (i = s(i, 3, Math.min(t, p(i, 3) - 1)),
                    ...
                    function G(l) {
                        for (var n = l.a.toString(), u = l.f.length, t = 0; t < u; ++t) {
                            ...
                            if (new RegExp("^(?:" + r + ")$").test(n))
                                return l.B = dl.test(s(e, 4)),
                                T(l, n = n.replace(new RegExp(r,"g"), s(e, 2)))
                        }
                        return ""
                    }
                    function T(l, n) {
                    ...
                    function I(l) {
                        ...
                        if (3 <= n.length) {
                            ...
                            return N(l, n),
                            0 < (n = G(l)).length ? n : C(l) ? P(l) : l.i.toString()
                        }
                        return T(l, n)
                    }
                    function P(l) {
                    ...
                    function V(l) {
                        var n, u = l.a.toString(), e = 0;
                        return (n = 1 == s(l.g, 10) && ("1" == (n = l.a.toString()).charAt(0) && "0" != n.charAt(1) && "1" != n.charAt(1))) ? (e = 1,
                        l.b.a("1").a(" "),
                        l.o = !0) : null != l.g.a[15] && (n = new RegExp("^(?:" + s(l.g, 15) + ")"),
                        null != (n = u.match(n)) && null != n[0] && 0 < n[0].length && (l.o = !0,
                        e = n[0].length,
                    ...
                    function $(l) {
                        ...
                        return null != (u = n.match(u)) && null != u[0] && 0 < u[0].length && (l.o = !0,
                        u = u[0].length,
                        t(l.a),
                        l.a.a(n.substring(u)),
                        t(l.b),
                    ...
                    function R(l) {
                        ...
                        return 0 != n && (t(l.a),
                        l.a.a(e.toString()),
                        "001" == (e = j(n)) ? l.g = A(l.G, "" + n) : e != l.D && (l.g = B(l, e)),
                        l.b.a("" + n).a(" "),
                        l.h = "",
                        !0)
                    }
                    ...
                    v.prototype.b = function(l, n) {
                        if (11 == l.a || 10 == l.a)
                            return n instanceof a ? n : this.a(l.i.prototype.j(), n);
                        if (14 == l.a) {
                        ...
                        if ((u = l.i) === String) {
                            if ("number" == typeof n)
                                return String(n)
                        } else if (u === Number && "string" == typeof n && ("Infinity" === n || "-Infinity" === n || "NaN" === n || Z.test(n)))
                            return Number(n);
                        return n
                    }
                    ;
                    ...
                    M.prototype.L = function(l) {
                        return this.C = function(l, n) {
                            l.i.a(n);
                            var u, e = n;
                            if (nl.test(e) || 1 == l.i.b.length && ll.test(e) ? ("+" == (e = n) ? (u = e,
                            l.u.a(e)) : (u = W[e],
                            l.u.a(u),
                            l.a.a(u)),
                            n = u) : (l.l = !1,
                            ...
                            !l.l) {
                                if (!l.F)
                                    if ($(l)) {
                                        if (R(l))
                                            return D(l)
                                    } else if (0 < l.h.length && (e = l.a.toString(),
                                    t(l.a),
                                    l.a.a(l.h),
                                    l.a.a(e),
                                    u = (e = l.b.toString()).lastIndexOf(l.h),
                                    t(l.b),
                                    l.b.a(e.substring(0, u))),
                                    l.h != V(l))
                                        return l.b.a(" "),
                                        D(l);
                                return l.i.toString()
                            ...
                            case 3:
                                ...
                                l.A = !0;
                            default:
                                return l.A ? (R(l) && (l.A = !1),
                                l.b.toString() + l.a.toString()) : 0 < l.f.length ? (e = E(l, n),
                                0 < (u = G(l)).length ? u : (N(l, l.a.toString()),
                                C(l) ? P(l) : l.l ? T(l, e) : l.i.toString())) : I(l)
                            }
                        }(this, l)
                    }
                    ,
                    l("Cleave.AsYouTypeFormatter", M),
                    l("Cleave.AsYouTypeFormatter.prototype.inputDigit", M.prototype.L),
                    l("Cleave.AsYouTypeFormatter.prototype.clear", M.prototype.K)
                }
        ...
        u.d = function(l, n) {
            for (var t in n)
                u.o(n, t) && !u.o(l, t) && Object.defineProperty(l, t, {
                    enumerable: !0,
                    get: n[t]
                })
        }
