...
$(function() {
    ...
    function countColumns() {
        ...
        if (permChange === "True") --columnLength
    ...
    function getColumnDefs() {
        let columnDefs = [{
            ...
            render: function(t, e, s, a) {
                const n = s.full_name
                    , o = "#";
                let i = '/static/images/avatars/avatar.jpg';
                if (s.avatar) {
                    i = s.avatar;
                } else if (s.gender === 'men') {
                    i = '/static/images/avatars/man.png';
                } else if (s.gender === 'women') {
                    i = '/static/images/avatars/woman.jpg';
                }
                return '<a href="'+ o +'" class="d-flex justify-content-start align-items-center product-name"><div class="avatar-wrapper"><div class="avatar avatar me-2 rounded-2 bg-label-secondary">' + (i ? '<img src="' + i + '" alt="' + n + '" height="82" class="rounded-2">' : '<span class="avatar-initial rounded-2 bg-label-">' + "</span>") + '</div></div><div class="d-flex flex-column"><h6 class="text-body text-nowrap mb-0">' + n + '</h6></div></a>'
            }
        },]
        if (permChange === "True") {
            columnDefs.push(
    ...
    $(".datatable-students tbody").on("click", ".delete-record", function() {
