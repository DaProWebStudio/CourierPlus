	...
	function() {
		...
		n.length && n.on("click", function() {
			...
			return function(t, e) {
				...
				o = [], n.filter(function(e) {
					if (e.name.toLowerCase().startsWith(t.toLowerCase())) o.push(e);
						...
						o.push(e), o.sort(function(e, t) {
							return t.name < e.name ? 1 : -1
						})
					}
				}), e(o)
			}
		}, $("#layout-menu").hasClass("menu-horizontal"), o = $.ajax({
			...
			a.typeahead({
				...
				source: t(o.books),
				templates: {
					header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Книги</h6>',
					suggestion: function({
						src: e,
						name: t,
						language: l,
						...
						return '<a href="javascript:;"><div class="d-flex w-100"><img class="me-3" src="/media/' + e + '" alt="' + t + '" height="82"><div class="w-100"><h6 class="mb-0">' + t + '</h6><span class="text-muted mt-2 d-block">Авторы: ' + a + '</span><span class="text-muted mt-1 d-block">Язык: ' + l + '</span></div></div></a>'
					},
					notFound: '<div class="not-found px-3 py-2"><h6 class="suggestions-header text-primary mb-2">Книги</h6><p class="py-2 mb-0"><i class="bx bx-error-circle bx-xs me-2"></i> Результатов не найдено</p></div>'
				}
