...
"undefined" != typeof $ && $(function() {
    ...
    var t, n, e, o = $(".search-toggler"), s = $(".search-input-wrapper"), a = $(".search-input"), l = $(".content-backdrop");
    ...
    ,
    o = "search-vertical.json",
    $("#layout-menu").hasClass("menu-horizontal") && (o = "search-horizontal.json"),
    n = $.ajax({
