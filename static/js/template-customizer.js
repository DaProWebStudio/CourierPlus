          ...
          , v = function() {
            function t(e) {
                ...
                !this._ssr) {
                    ...
                    this.pathResolver = A || function(t) {
                        return t
                    }
                    ,
            ...
            (s = [{
                ...
                key: "setStyle",
                value: function(t) {
                    this._hasControls("style") && (this._setSetting("Style", -1 === ["dark"].indexOf(t) ? "light" : t),
                    window.location.reload())
                }
            }, {
                key: "setTheme",
                value: function(t) {
                    ...
                    if (this._hasControls("themes")) {
                        ...
                        if (i) {
                            ...
                            this._loadStylesheets(a({}, o, document.querySelector(".template-customizer-theme-css")), s || function() {}
                            ),
                ...
                value: function(t) {
                    ...
                    if (this._hasControls("layoutType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                        ...
                        "fixed" === this.settings.layoutType || "fixed-offcanvas" === this.settings.layoutType ? i && s && (window.Helpers.menuPsScroll.destroy(),
                ...
                value: function(t) {
                    var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                    this._hasControls("layoutMenuFlipped") && (this.settings.layoutMenuFlipped = t,
                    e && this._setSetting("MenuFlipped", t),
                    window.Helpers.setFlipped(t),
                    e && this.settings.onSettingsChange.call(this, this.settings))
                }
            }, {
                ...
                value: function(t) {
                    var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                    this._hasControls("layoutNavbarFixed") && (this.settings.layoutNavbarFixed = t,
                    e && this._setSetting("FixedNavbar", t),
                    window.Helpers.setNavbarFixed(t),
                    e && this.settings.onSettingsChange.call(this, this.settings))
                }
            }, {
                ...
                value: function(t) {
                    var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                    this._hasControls("layoutFooterFixed") && (this.settings.layoutFooterFixed = t,
                ...
                value: function() {
                    if (!this._ssr) {
                        ...
                        this._controls.layoutMenuFlipped && (e ? (this._controls.layoutMenuFlipped.removeAttribute("disabled"),
                        this._controls.layoutMenuFlipped.classList.remove("disabled")) : (this._controls.layoutMenuFlipped.setAttribute("disabled", "disabled"),
                        ...
                        this._controls.layoutNavbarFixed && (t ? (this._controls.layoutNavbarFixed.removeAttribute("disabled"),
                        this._controls.layoutNavbarFixedW.classList.remove("disabled")) : (this._controls.layoutNavbarFixed.setAttribute("disabled", "disabled"),
                        this._controls.layoutNavbarFixedW.classList.add("disabled"))),
                        this._controls.layoutFooterFixed && (o ? (this._controls.layoutFooterFixed.removeAttribute("disabled"),
                        ...
                        this._controls.layoutType && (!t && !e || !e && !i ? this._controls.layoutType.setAttribute("disabled", "disabled") : this._controls.layoutType.removeAttribute("disabled"),
                ...
                key: "_loadSettings",
                value: function() {
                    var t, e = this._getSetting("Rtl"), s = this._getSetting("Style"), i = this._getSetting("LayoutCollapsed"), o = this._getSetting("LayoutMenuFlipped"), a = this._getSetting("ShowDropdownOnHover"), n = this._getSetting("FixedNavbar"), l = this._getSetting("FixedFooter"), r = this._getSetting("LayoutType");
                ...
                value: function() {
                    ...
                    this._listeners.push([i, "click", a]);
                    ...
                    this._listeners.push([n, "click", l]);
                    ...
                    if (this._hasControls("rtl") && rtlSupport) {
                        ...
                        this._listeners.push([c, "change", u])
                    } else
                    ...
                    if (this._hasControls("themes")) {
                        ...
                        this._listeners.push([y, "change", f])
                    } else
                    ...
                    if (this._hasControls("layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover", !0)) {
                        ...
                        if (this._hasControls("layoutType")) {
                            ...
                            this._listeners.push([this._controls.layoutType, "change", b])
                        } else
                            v.parentNode.removeChild(v);
                        if (this._controls.showDropdownOnHover = this.container.querySelector(".template-customizer-showDropdownOnHover"),
                        this._hasControls("showDropdownOnHover")) {
                            ...
                            this._listeners.push([this._controls.showDropdownOnHover, "change", _])
                        } else
                            this._controls.showDropdownOnHover.parentNode.removeChild(this._controls.showDropdownOnHover);
                        if (this._controls.layoutNavbarFixedW = this.container.querySelector(".template-customizer-layoutNavbarFixed"),
                        this._hasControls("layoutNavbarFixed")) {
                            ...
                            this._listeners.push([this._controls.layoutNavbarFixed, "change", w])
                        } else
                            this._controls.layoutNavbarFixedW.parentNode.removeChild(this._controls.layoutNavbarFixedW);
                        if (this._controls.layoutFooterFixedW = this.container.querySelector(".template-customizer-layoutFooterFixed"),
                        this._hasControls("layoutFooterFixed")) {
                            ...
                            this._listeners.push([this._controls.layoutFooterFixed, "change", x])
                        } else
                ...
                value: function(t, e) {
                    ...
                    function a(t, e, s) {
                        ...
                        var o, a = "sheet"in i ? "sheet" : "styleSheet", n = "sheet"in i ? "cssRules" : "rules", l = setTimeout((function() {
                            clearInterval(o),
                            clearTimeout(l),
                        ...
                        o = setInterval((function() {
                            try {
                                i[a] && i[a][n].length && (clearInterval(o),
                                clearTimeout(l),
        ...
        t.exports = function(t) {
                ...
                return this.map((function(e) {
                    var s = function(t, e) {
                        ...
                        if (e && "function" == typeof btoa) {
                            var o = (n = i,
                            l = btoa(unescape(encodeURIComponent(JSON.stringify(n)))),
                            r = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(l),
                            "/*# ".concat(r, " */"))
            ...
            e.i = function(t, s, i) {
                ...
                for (var l = 0; l < t.length; l++) {
                    var r = [].concat(t[l]);
                    i && o[r[0]] || (s && (r[2] ? r[2] = "".concat(s, " and ").concat(r[2]) : r[2] = s),
                    e.push(r))
                }
            }
            ,
